...
st.sidebar.markdown(
    "- Career outcomes / salary: [First Destination Survey](https://www.naceweb.org/job-market/graduate-outcomes/first-destination/class-of-2024/first-destinations-for-the-college-class-of-2024-interactive-dashboard/)")
# -----------------------------
# Load data
# -----------------------------
from pathlib import Path
